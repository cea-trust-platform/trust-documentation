...
The software was primarily designed for solving incompressible single-phase flows. You can now also use it for solving multiphase flow problems.
...
Do not forget to cite TRUST, see: https://cea-trust-platform.github.io/cite.html
