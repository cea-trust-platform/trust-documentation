...
When speaking of the **TRUST** code, we use the world platform as it serves as a base for other CEA code, called BALTIKS. These codes usually (but not restricted to!) have various applications around thermohydraulic problems. `TrioCFD <https://triocfd-documentation.readthedocs.io/en/latest/>`_ is one of those BALTIKS.
