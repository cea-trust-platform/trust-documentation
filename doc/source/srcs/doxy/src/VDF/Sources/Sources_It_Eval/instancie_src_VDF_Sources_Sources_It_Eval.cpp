...
Terme_Puissance_Thermique_QC_VDF_Elem inst7;verifie_pere(inst7);
Terme_Puissance_Thermique_VDF_Elem inst8;verifie_pere(inst8);
Terme_Source_Constituant_VDF_Elem inst9;verifie_pere(inst9);
}
